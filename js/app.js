(() => {
    ...
    function initSliders() {
        if (document.querySelector(".grid__slider")) new core(".grid__slider", {
        ...
        if (document.querySelector(".slidersolo_block__slider")) new core(".slidersolo_block__slider", {
            modules: [ Navigation, Pagination, Scrollbar, Keyboard, Mousewheel, Autoplay, Grid ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
            initialSlide: 0,
    ...
    let gridWorks = document.querySelectorAll(".grid_work");
    let gridWorksFirstR = document.querySelectorAll(".first_right");
    if (gridWorks) {
        let firstWorks = document.querySelectorAll(".grid_work_img1");
        firstWorks.forEach((firstWork => {
            let firstWorkWidth = firstWork.clientWidth / 2 - 5;
            firstWork.setAttribute("rowsheight", `${firstWorkWidth}px`);
        }));
        firstWorks.forEach((firstWork => {
            firstWork.parentNode.style.gridAutoRows = `${firstWork.getAttribute("rowsheight")}`;
        }));
        gridWorks.forEach((gridWork => {
            let gridWorkImgsImg = gridWork.querySelectorAll(".grid_work_img img");
            gridWorkImgsImg.forEach((element => {
                if (!element.src.includes(".png" || 0 || 0 || 0 || 0)) element.parentNode.remove();
            }));
            let gridWorkImgs = gridWork.querySelectorAll(".grid_work_img");
            gridWorkImgs.forEach((gridWorkImg => {
                if (0 == gridWorkImg.children.length) gridWorkImg.remove();
            }));
            if (0 == gridWork.children.length) gridWork.remove();
            let gridSlides = document.querySelectorAll(".grid__slide");
            gridSlides.forEach((element => {
                if (0 == element.children.length) element.remove();
            }));
            if (1 == gridWork.children.length) gridWork.children[0].style.gridArea = "1 / 1 / 3 / 5";
            if (2 == gridWork.children.length) gridWork.children[1].style.gridArea = "1 / 3 / 3 / 5";
            if (3 == gridWork.children.length) {
                gridWork.children[1].style.gridArea = "1 / 3 / 2 / 5";
                gridWork.children[2].style.gridArea = "2 / 3 / 3 / 5";
            }
            if (4 == gridWork.children.length) {
                gridWork.children[1].style.gridArea = "1 / 3 / 2 / 5";
                gridWork.children[2].style.gridArea = "2 / 3 / 3 / 4";
                gridWork.children[3].style.gridArea = "2 / 4 / 3 / 5";
            }
            if (5 == gridWork.children.length) {
                gridWork.children[1].style.gridArea = "1 / 3 / 2 / 4";
                gridWork.children[2].style.gridArea = "1 / 4 / 2 / 5";
            }
        }));
    }
    if (gridWorksFirstR) gridWorksFirstR.forEach((gridWorkFirstR => {
        if (3 == gridWorkFirstR.children.length) {
            gridWorkFirstR.children[0].style.gridArea = "1 / 3 / 3 / 5";
            gridWorkFirstR.children[1].style.gridArea = "1 / 1 / 2 / 3";
        }
        if (3 == gridWorkFirstR.children.length) {
            gridWorkFirstR.children[0].style.gridArea = "1 / 3 / 3 / 5";
            gridWorkFirstR.children[1].style.gridArea = "1 / 1 / 2 / 3";
            gridWorkFirstR.children[2].style.gridArea = "2 / 1 / 3 / 3";
        }
        if (4 == gridWorkFirstR.children.length) {
            gridWorkFirstR.children[0].style.gridArea = "1 / 3 / 3 / 5";
            gridWorkFirstR.children[1].style.gridArea = "1 / 1 / 2 / 2";
            gridWorkFirstR.children[2].style.gridArea = "1 / 2 / 2 / 3";
            gridWorkFirstR.children[3].style.gridArea = "2 / 1 / 3 / 3";
        }
        if (5 == gridWorkFirstR.children.length) {
            gridWorkFirstR.children[0].style.gridArea = "1 / 3 / 3 / 5";
            gridWorkFirstR.children[1].style.gridArea = "1 / 1 / 2 / 2";
            gridWorkFirstR.children[2].style.gridArea = "1 / 2 / 2 / 3";
            gridWorkFirstR.children[3].style.gridArea = "2 / 1 / 3 / 2";
            gridWorkFirstR.children[4].style.gridArea = "2 / 2 / 3 / 3";
        }
    }));
    let slideImgs = document.querySelectorAll(".slide_img img");
    if (slideImgs) slideImgs.forEach((element => {
        if (!element.src.includes(".png" || 0 || 0 || 0 || 0)) element.parentNode.parentNode.remove();
    }));
    let membersImgsConts = document.querySelectorAll(".member_imgs");
    if (membersImgsConts) membersImgsConts.forEach((membersImgsCont => {
        let memberImgs = membersImgsCont.querySelector(".member_img3 img");
        let memberImg2 = membersImgsCont.querySelector(".nophoto");
        if (memberImgs.src.includes(".png" || 0 || 0 || 0 || 0)) memberImg2.remove();
        if (!memberImgs.src.includes(".png" || 0 || 0 || 0 || 0)) memberImgs.remove();
    }));
    document.addEventListener("watcherCallback", (function(e) {
        ...
        if (entry.isIntersecting) {
            ...
            if (targetElement.classList.contains("main_title")) !targetElement.classList.contains("fadeInLeft") ? targetElement.classList.add("fadeInLeft") : null;
            if (targetElement.classList.contains("desc_title")) !targetElement.classList.contains("fadeInLeft") ? targetElement.classList.add("fadeInLeft") : null;
            if (targetElement.classList.contains("desc_label")) !targetElement.classList.contains("fadeInLeft") ? targetElement.classList.add("fadeInLeft") : null;
        } else {
